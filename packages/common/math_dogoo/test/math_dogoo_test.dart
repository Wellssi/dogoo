...
void main() {
  group('📌 MathDogoo - Function Test', () {
    ...
    test('👉 x의 atanh 값을 반환 - NaN 반환', () {
      expect(atanh(double.nan), isNaN);
      expect(atanh(-double.nan), isNaN);
    ...
    test('👉 x의 밑이 2인 로그 값 반환', () {
      expect(log2(1.0), 0.0);
      expect(absolute(1 - log2(2)) < epsilon, isTrue);
      expect(absolute(2 - log2(4)) < epsilon, isTrue);
    });
  ...
  group('📌 MathDogoo - Extension Test', () {
    ...
    test('👉 x의 acosh 값을 반환', () {
      expect(1.0.acosh(), 0.0);
      expect(absolute(2.acosh() - 1.3169578969248166) < epsilon, isTrue);
    });

    test('👉 x의 acosh 값을 반환 - NaN 반환', () {
      expect(0.0.acosh(), isNaN);
      expect((-1.0).acosh(), isNaN);
    });

    test('👉 x의 asinh 값을 반환', () {
      expect(0.0.asinh(), 0.0);
      expect(absolute(2.asinh() - 1.4436354751788103) < epsilon, isTrue);
    });

    test('👉 x의 atanh 값을 반환', () {
      expect(0.0.atanh(), 0.0);
      expect(absolute(0.5.atanh() - 0.5493061443340549) < epsilon, isTrue);
    });

    test('👉 x의 atanh 값을 반환 - infinity 반환', () {
      expect(1.0.atanh(), double.infinity);
      expect((-1.0).atanh(), double.infinity);
    });

    test('👉 x의 atanh 값을 반환 - NaN 반환', () {
      expect(double.nan.atanh(), isNaN);
      expect((-double.nan).atanh(), isNaN);
      expect(2.0.atanh(), isNaN);
      expect((-2.0).atanh(), isNaN);
    });

    test('👉 x의 cosh 값을 반환', () {
      expect(0.0.cosh(), 1.0);
      expect(absolute(1.cosh() - 1.5430806348152437) < epsilon, isTrue);
    });

    test('👉 x의 cosh 값을 반환 - NaN 반환', () {
      expect(double.nan.cosh(), isNaN);
      expect((-double.nan).cosh(), isNaN);
    });
    ...
    test('👉 x! 반환 - NaN 반환', () {
      expect((-5).factorial(), isNaN);
    });

    test('👉 x의 밑이 2인 로그 값 반환', () {
      expect(1.0.log2(), 0.0);
      expect(absolute(1 - 2.log2()) < epsilon, isTrue);
      expect(absolute(2 - 4.log2()) < epsilon, isTrue);
    });

    test('👉 x의 밑이 2인 로그 값 반환 - NaN 반환', () {
      expect(double.nan.log2(), isNaN);
      expect((-double.nan).log2(), isNaN);
    });
    ...
    test('👉 x의 sinh 값을 반환', () {
      expect(0.0.sinh(), 0.0);
      expect(absolute(1.sinh() - 1.1752011936438014) < epsilon, isTrue);
    });

    test('👉 x의 tanh 값을 반환', () {
      expect(0.0.tanh(), 0.0);
      expect(absolute(1.tanh() - 0.7615941559557649) < epsilon, isTrue);
    });
  });
}
